        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Your personal AI trip planner and travel curator, creating custom itineraries 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/about" className="text-gray-600 hover:text-orange-500 text-sm">About Us</a>
              </li>
              <li>
                <a href="/contact" className="text-gray-600 hover:text-orange-500 text-sm">Contact</a>
              </li>
              <li>
                <a href="/privacy" className="text-gray-600 hover:text-orange-500 text-sm">Privacy Policy</a>
              </li>
              <li>
                <a href="/terms" className="text-gray-600 hover:text-orange-500 text-sm">Terms of Service</a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 text-sm">Email: support@travelease.com</li>
              <li className="text-gray-600 text-sm">Phone: +1 (555) 123-4567</li>
              <li className="text-gray-600 text-sm">Address: 123 Travel Street, City, Country</li>
            </ul>
          </div>
